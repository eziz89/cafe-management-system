...
<div class="max-w-5xl mx-auto sm:pt-4 pb-8 sm:px-0 px-4">
    ...
    <div class="sm:mb-6 mb-4">
        ...
        <p class="text-stone-500 mt-2">
            Menýuňyzy tertipleşdirmek üçin täze kategoriýa goşuň.
        </p>
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <textarea
                    name="description"
                    rows="4"
                    placeholder="Kategoriýanyň beýany"
                    class="w-full rounded-2xl border border-stone-300
                        px-5 py-4
                        focus:outline-none
                        focus:ring-2
                        focus:ring-orange-300">{{ old('description') }}</textarea>
            ...
            <div class="sm:mb-8 mb-4">
                ...
                <textarea
                    ...
                    class="w-full rounded-2xl border border-stone-300
                        px-5 py-4 mb-3
                        focus:outline-none focus:ring-2
                        focus:ring-orange-300">{{ old('description_en') }}</textarea>
                ...
                <textarea
                    ...
                    class="w-full rounded-2xl border border-stone-300
                        ...
                        focus:outline-none
                        focus:ring-2
                        focus:ring-orange-300">{{ old('description_ru') }}</textarea>
