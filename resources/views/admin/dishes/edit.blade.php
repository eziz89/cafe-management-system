    ...
    <div class="max-w-5xl mx-auto px-6 pb-10">
        ...
        <div class="sm:mb-6 mb-4">
            ...
            <p class="text-stone-500 mt-2">
                Tagam baradaky maglumatlary we bahalary täzeläň.
            </p>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-lg p-8">
            ...
            <form method="POST" action="/admin/dishes/{{ $dish->id }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    @if($dish->image)
                        ...
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <img src="{{ asset('storage/' . $dish->image) }}"
                                class="w-32 h-32 object-cover rounded-2xl shadow">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-stone-500">
                                    Zerur bolsa, aşakdakylary çalşyň
                                </p>
                            </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            placeholder="0.00"
                            class="pl-14 p-3 rounded-2xl border w-full focus:ring-2 focus:ring-orange-300">
