...
<section class="min-h-screen bg-stone-100 flex items-center justify-center pt-12 pb-24">
    ...
    <div class="max-w-2xl w-full bg-white rounded-[3rem] shadow-2xl p-14 text-center">
        ...
        <div class="flex justify-center gap-4">
            <a href="/menu" class="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-2xl font-semibold transition">
                Continue Browsing
            </a>
