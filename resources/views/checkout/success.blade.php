...
<section class="min-h-screen bg-stone-100 flex items-center justify-center px-6">
    ...
    <div class="max-w-2xl w-full bg-white rounded-[3rem]
                shadow-2xl p-14 text-center">

        <div class="w-28 h-28 mx-auto rounded-full
                    bg-green-100 flex items-center
                    justify-center text-5xl mb-10">
        ...
        <p class="text-stone-500 text-lg leading-relaxed mb-12">
            ...
            Our team is preparing your delicious meals
            and will process your request shortly.
